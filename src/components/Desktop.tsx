              ...
              <div className="content">
                <section id="sec-top">
                  <div className="slot hero sunken">
                    <Image src="/assets/hero-snoofi.png" alt="Snoofi dogs under a SNOOFI stop sign, one holding a phone showing the Robinhood logo" width={3168} height={1056} unoptimized priority />
                  </div>
                </section>
        ...
        {dialogs.map((dialog) => (
          <div className="win dlg" key={dialog.id} style={{ left: dialog.left, top: dialog.top, zIndex: dialog.z }} onPointerDown={() => { const z = ++zTop.current; setDialogs((current) => current.map((item) => item.id === dialog.id ? { ...item, z } : item)); }}>
            ...
            <div className="content2">
              ...
              {dialog.kind === "howto" && <div className="steps"><div className="step"><div className="step-n">Step 1</div><h4>Create a wallet</h4><p>Download the MetaMask extension or mobile app. Create a new wallet and safely back up your seed phrase. It takes about a minute.</p></div><div className="step"><div className="step-n">Step 2</div><h4>Add Robinhood Chain</h4><p>Add the network manually with the official details from Robinhood&apos;s docs.</p></div><div className="step"><div className="step-n">Step 3</div><h4>Fund your wallet</h4><p>Bridge or send $RDDT to your wallet on Robinhood Chain.</p></div><div className="step"><div className="step-n">Step 4</div><h4>Swap for $SNOOFI</h4><p>Paste the $SNOOFI contract into the PONS launchpad and swap.</p></div><div className="step"><div className="step-n">Step 5</div><h4>Join the community</h4><p>You&apos;re officially a Snoofi holder. Come say hi on r/snoofipons.</p></div></div>}
